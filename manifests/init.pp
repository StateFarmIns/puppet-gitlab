...
class gitlab (
  ...
  Enum['present', 'absent']      $pgpass_file_ensure            = 'absent',
  String                         $pgpass_file_location          = '/home/gitlab-consul/.pgpass',
  String                         $pgpass_file_owner             = 'gitlab-consul',
  String                         $pgpass_file_group             = 'gitlab-consul',
